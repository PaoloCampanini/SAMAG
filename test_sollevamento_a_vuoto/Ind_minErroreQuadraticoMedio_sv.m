...
%   due segnali fonriti ome srgomenti della funzione. L'indice di
%   somigianza è dato dal minimo errore quadratico tra i due segnali.

%   INPUTS:
%   Sn: struct. Segnale nominale.
%   S: struct. Segnale che si vuole confrontare con il segnale nominale.
%
%   OUTPUTS:
%   ind: scalare. Indice di somiglianza, minimo errore quadratico medio tra
%       i due segnali.
